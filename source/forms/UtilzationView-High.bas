...
PublishOption =1
    ...
    Tag ="SplitList"
    Filter ="(((([Contacts].[Manager])=[Forms]![UtilzationView-High]![AssignedResourceManager"
        "])) Or ([Forms]![UtilzationView-High]![AssignedResourceManager] Is Null))"
    Picture ="office.png"
        0x6e59abab2a3ae440
    End
    RecordSource ="PEMUtilzation-High"
                ...
                End
                    ...
                    ColumnWidths ="0;1440"
                        ...
                        ColumnsShown =0
                            Action ="ApplyFilter"
                            Argument =""
                            Argument ="(((([Contacts].[Manager])=[Forms]![UtilzationView-High]![AssignedResourceManager"
                                "])) Or ([Forms]![UtilzationView-High]![AssignedResourceManager] Is Null))"
                        End
                        ...
                        End
                            Comment ="_AXL:accessservices/2009/11/forms\"><Statements><Action Name=\"ApplyFilter\"><Ar"
                                ...
                                "-High]![AssignedResourceManager])) Or ([Forms]![UtilzationView-High]![AssignedRe"
                                "sourceManager] Is "
                        End
                            Comment ="_AXL:Null))</Argument></Action></Statements></UserInterfaceMacro>"
                        End
                    End
        ...
        End
            ...
            Name ="Detail"
                ...
                End
                    ...
                    LayoutCachedLeft =26670
                    LayoutCachedTop =480
                    LayoutCachedWidth =28110
                    LayoutCachedHeight =795
                    ColumnStart =15
                    ColumnEnd =15
                    LayoutGroup =2
                ...
                End
                    ...
                    LayoutCachedLeft =28170
                    LayoutCachedTop =480
                    LayoutCachedWidth =29610
                    LayoutCachedHeight =795
                    ColumnStart =16
                    ColumnEnd =16
                    LayoutGroup =2
                ...
                End
                    ...
                    LayoutCachedLeft =29670
                    LayoutCachedTop =480
                    LayoutCachedWidth =31110
                    LayoutCachedHeight =795
                    ColumnStart =17
                    ColumnEnd =17
                    LayoutGroup =2
                ...
                End
                    ...
                    LayoutCachedLeft =30210
                    LayoutCachedTop =480
                    LayoutCachedWidth =31650
                    LayoutCachedHeight =795
                    ColumnStart =18
                    ColumnEnd =18
                    LayoutGroup =2
                ...
                End
                    ...
                    GridlineColor =10921638
                        ...
                        End
                            ...
                            Argument ="0"
                            Argument =""
                            Argument ="=\"[FullName]=\" & \"[Screen].[ActiveControl]\""
                            Argument ="-1"
                            Argument ="3"
                        End
                            Action ="OnError"
                        ...
                        End
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"FullName\" Event=\"OnClick\" xmlns=\"http://schemas.microsof"
                                "t.com/office/accessservices/2009/11/application\" xmlns:a=\"http://schemas.micro"
                                "soft.com/office/accessservices/2"
                        End
                            Comment ="_AXL:009/11/forms\"><Statements><ConditionalBlock><If><Condition>IsNull([Screen]"
                                ".[ActiveControl])</Condition><Statements><Action Name=\"StopMacro\"/></Statement"
                                "s></If></ConditionalBlock><Action Name=\"OpenForm\"><Argument Name=\"FormName\">"
                                "ContactDetails</Argu"
                        End
                            Comment ="_AXL:ment><Argument Name=\"WhereCondition\">=\"[FullName]=\" &amp; \"[Screen].[A"
                                "ctiveControl]\"</Argument><Argument Name=\"WindowMode\">Dialog</Argument></Actio"
                                "n><Action Name=\"OnError\"/><Action Name=\"Requery\"><Argument Name=\"ControlNam"
                                "e\">=[Screen].[ActiveContro"
                        End
                            Comment ="_AXL:l].[Name]</Argument></Action></Statements></UserInterfaceMacro>"
                        End
                    End
