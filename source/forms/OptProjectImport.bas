...
PublishOption =1
    ...
    Tag ="SplitList"
    Filter ="(((Request.RequestTypeID=6))) And (OptimizationList.StatusID=110)"
    OrderBy ="[Lookup_Customer Name].[CustomerName], [OptimizationList].[RequestID]"
    Picture ="office.png"
        0xe1e23142df3be440
    End
            ...
            Name ="Detail"
                ...
                End
                    ...
                    GroupTable =10
                            ...
                            Height =1050
                            Name ="Label1039"
                            Caption ="InitialRequestDescription"
                            GroupTable =10
                            BottomPadding =150
                            GridlineColor =10921638
                            LayoutCachedLeft =1020
                ...
                End
                    ...
                    RowSource ="SELECT CustomersTable.CustomerID, CustomersTable.CustomerName FROM CustomersTabl"
                        "e ORDER BY CustomersTable.CustomerName; "
                    ColumnWidths ="0;1440"
                    BaseInfo ="\"SELECT CustomersTable.CustomerID, CustomersTable.CustomerName FROM CustomersTa"
                        "ble ORDER BY CustomersTable.CustomerName; \";\"CustomersTable\";\"\";\"CustomerI"
                        "D\";\"CustomerName\";\"PrimaryKey\""
                    GroupTable =10
                    BottomPadding =150
                    GridlineColor =10921638
