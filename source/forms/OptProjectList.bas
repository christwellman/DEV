...
PublishOption =1
    ...
    Tag ="SplitList"
    Filter ="((((Request.RequestTypeID=6))) And (Lookup_StatusID.[DCPM Project Status]=\"Rada"
        "r\")) And (OptimizationList.ContractEndDate>=#8/2/2013#)"
    OrderBy ="[OptimizationList].[EndDate] DESC, [Lookup_Customer Name].[CustomerName], [Optim"
        "izationList].[RequestID]"
    Picture ="office.png"
        0xe1e23142df3be440
    End
    RecordSource ="OptimizationList"
    ...
    DatasheetGridlinesColor12 =-1
        ...
        End
            ...
            Name ="FormHeader"
                    ...
                    FontSize =18
                    Name ="Auto_Title0"
                    Caption ="Optimization Project List"
                    LayoutCachedLeft =60
                    LayoutCachedTop =60
                    ...
                    GridlineColor =-2147483609
                        ...
                        End
                            Comment ="_AXL:ces/2009/11/forms\"><Statements><Action Name=\"OpenForm\"><Argument Name=\""
                                "FormName\">OptProjectDetails</Argument><Argument Name=\"WhereCondition\">1=0</Ar"
                                "gument><Argument Name=\"WindowMode\">Dialog</Argument></Action><Action Name=\"On"
                                "Error\"/><Action Name=\"R"
                        End
                            Comment ="_AXL:equery\"/><Action Name=\"SearchForRecord\"><Argument Name=\"WhereCondition\""
                                ">=\"[RequestID]=\" &amp; Nz(DMax(\"[RequestID]\",[Form].[RecordSource]),0)</Argu"
        ...
        End
            ...
            Name ="Detail"
                    ...
                    GridlineColor =10921638
                        ...
                        End
                            Comment ="_AXL:atements></If></ConditionalBlock><ConditionalBlock><If><Condition>IsNull([R"
                                ...
                                "ormName\">OptProj"
                        End
                            Comment ="_AXL:ectDetails</Argument><Argument Name=\"DataMode\">Add</Argument><Argument Na"
                                "me=\"WindowMode\">Dialog</Argument></Action></Statements></If><Else><Statements>"
                                "<Comment>Use a TempVar to pass a filte rto teh OpenForm Action</Comment><Action "
                                "Name=\"SetTempVar\""
                        End
                            Comment ="_AXL:><Argument Name=\"Name\">ProjectDetails_ID</Argument><Argument Name=\"Expre"
                                "ssion\">[ID]</Argument></Action><Action Name=\"OpenForm\"><Argument Name=\"FormN"
                                "ame\">OptProjectDetails</Argument><Argument Name=\"WhereCondition\">[RequestID]="
                                "[TempVars]![ProjectDeta"
                        End
                            Comment ="_AXL:ils_ID]</Argument><Argument Name=\"DataMode\">Edit</Argument><Argument Name"
                                "=\"WindowMode\">Dialog</Argument></Action><Action Name=\"RemoveTempVar\"><Argume"
                                "nt Name=\"Name\">ProjectDetails_ID</Argument></Action><Action Name=\"RefreshReco"
                                "rd\"/></Statements></El"
                        End
                            Comment ="_AXL:se></ConditionalBlock></Statements><Sub Name=\"ErrorHandler\"><Statements><"
                                "Action Collapsed=\"true\" Name=\"MessageBox\"><Argument Name=\"Message\">=[Macro"
                                "Error].[Description]</Argument></Action></Statements></Sub></UserInterfaceMacro>"
                        End
                    End
                ...
                End
                    ...
                    ColumnInfo ="\"\";\"\";\"10\";\"510\""
                    Name ="Opt/Residency"
                    ControlSource ="Opt/Residency"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT DISTINCT OptimizationData.[Opt/Residency] FROM OptimizationData WHERE ((("
                        "OptimizationData.[Opt/Residency]) Is Not Null)); "
                    EventProcPrefix ="Opt_Residency"
                    Format ="@"
                    GroupTable =9
                    GridlineColor =10921638
                ...
                End
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT RequestStatus.StatusID, RequestStatus.[DCPM Project Status], RequestStatu"
                        "s.Order FROM RequestStatus ORDER BY RequestStatus.Order DESC; "
                    ColumnWidths ="0;1440"
                    BaseInfo ="\"SELECT RequestStatus.StatusID, RequestStatus.[DCPM Project Status], RequestSta"
                        "tus.Order FROM RequestStatus ORDER BY RequestStatus.Order DESC; \";\"RequestStat"
                        "us\";\"\";\"StatusID\";\"DCPM Project Status\";\"PrimaryKey\""
                    GroupTable =9
                    GridlineColor =10921638
                ...
                End
                    ...
                    ColumnOrder =9
                    TabIndex =1
                    Name ="InitialRequestDescription"
                    ControlSource ="InitialRequestDescription"
                    GroupTable =9
                    GridlineColor =10921638
                    TextFormat =1
                    ...
                    GroupTable =9
                            ...
                            Height =315
                            Name ="Label964"
                            Caption ="SO && SKU Booked"
                            GroupTable =9
                            GridlineColor =10921638
                            LayoutCachedLeft =17835
                            LayoutCachedTop =120
