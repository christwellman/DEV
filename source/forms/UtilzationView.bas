...
PublishOption =1
    ...
    Tag ="SplitList"
    Filter ="(((Assignments.ContactID=IsNull(Forms!UtilzationView!EMPMName) Or Assignments.Co"
        "ntactID=Forms!UtilzationView!EMPMName))) And (((((Request.StatusID)=200 Or (Requ"
        "est.StatusID)=210 Or (Request.StatusID)=220 Or (Request.StatusID)=230))))"
    Picture ="office.png"
        0x314abdc4283ae440
    End
    ...
    DatasheetGridlinesColor12 =-1
        ...
        End
            ...
            Name ="FormHeader"
                ...
                End
                    ...
                    ColumnOrder =3
                    ColumnInfo ="\"\";\"\";\"\";\"\";\"10\";\"486\""
                    Name ="AssignedResourceManager"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT Contacts.ContactID, Contacts.FullName FROM Contacts WHERE (((Contacts.Con"
                        "tactID)=497 Or (Contacts.ContactID)=451 Or (Contacts.ContactID)=619 Or (Contacts"
                        ".ContactID)=623)); "
                    ColumnWidths ="0;1440"
                        Version =196611
                        ColumnsShown =0
                            Action ="ApplyFilter"
                            Argument =""
                            Argument ="(((([Contacts].[Manager])=[Forms]![UtilzationView]![AssignedResourceManager])) O"
                                "r ([Forms]![UtilzationView]![AssignedResourceManager] Is Null))"
                        End
                            Action ="Requery"
                            Argument ="EMPMName"
                        End
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"AssignedResourceManager\" Event=\"OnChange\" xmlns=\"http://"
                                "schemas.microsoft.com/office/accessservices/2009/11/application\" xmlns:a=\"http"
                                "://schemas.microsoft.com/office/"
                        End
                            Comment ="_AXL:accessservices/2009/11/forms\"><Statements><Action Name=\"ApplyFilter\"><Ar"
                                "gument Name=\"WhereCondition\">(((([Contacts].[Manager])=[Forms]![UtilzationView"
                                "]![AssignedResourceManager])) Or ([Forms]![UtilzationView]![AssignedResourceMana"
                                "ger] Is Null))</Ar"
                        End
                            Comment ="_AXL:gument></Action><Action Name=\"Requery\"><Argument Name=\"ControlName\">EMP"
                                "MName</Argument></Action></Statements></UserInterfaceMacro>"
                        End
                    End

                    LayoutCachedLeft =1425
                    LayoutCachedTop =720
                    LayoutCachedWidth =3535
                ...
                End
                    ...
                    Name ="EMPMName"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT Contacts.ContactID, Contacts.FullName FROM Contacts WHERE (((Contacts.Man"
                        "ager)=[Forms]![UtilzationView]![AssignedResourceManager] Or (Contacts.Manager)=I"
                        "sNull([Forms]![UtilzationView]![AssignedResourceManager]))) ORDER BY Contacts.La"
                        "stName; "
                    ColumnWidths ="0;1440"
                        Version =196611
                        ColumnsShown =0
                            Action ="ApplyFilter"
                            Argument =""
                            Argument ="((([Assignments].[ContactID])=IsNull([Forms]![UtilzationView]![EMPMName]))) Or ("
                                "(([Assignments].[ContactID])=[Forms]![UtilzationView]![EMPMName]))"
                        End
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"EMPMName\" Event=\"OnChange\" xmlns=\"http://schemas.microso"
                                "ft.com/office/accessservices/2009/11/application\" xmlns:a=\"http://schemas.micr"
                                "osoft.com/office/accessservices/"
                        End
                            Comment ="_AXL:2009/11/forms\"><Statements><Action Name=\"ApplyFilter\"><Argument Name=\"W"
                                "hereCondition\">((([Assignments].[ContactID])=IsNull([Forms]![UtilzationView]![E"
                                "MPMName]))) Or ((([Assignments].[ContactID])=[Forms]![UtilzationView]![EMPMName]"
                                "))</Argument></Act"
                        End
                            Comment ="_AXL:ion></Statements></UserInterfaceMacro>"
                        End
                    End
                    ...
                    LayoutCachedHeight =1080
                        ...
                        End
                            ...
                            GridlineColor =10921638
                                ...
                                ColumnsShown =0
                                    Action ="ApplyFilter"
                                    Argument ="\"Active Projects\""
                                End
                                    Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                        "nterfaceMacro For=\"Option2087\" Event=\"OnMouseDown\" xmlns=\"http://schemas.mi"
                                        "crosoft.com/office/accessservices/2009/11/application\" xmlns:a=\"http://schemas"
                                        ".microsoft.com/office/accessserv"
                                End
                                    Comment ="_AXL:ices/2009/11/forms\"><Statements><Action Name=\"ApplyFilter\"><Argument Nam"
                                        "e=\"FilterName\">\"Active Projects\"</Argument></Action></Statements></UserInter"
                                        "faceMacro>"
                                End
                            End
                        ...
                        End
                            ...
                            GridlineColor =10921638
                                ...
                                ColumnsShown =0
                                    Action ="ApplyFilter"
                                    Argument =""
                                    Argument ="((([Request].[StatusID])=240 Or ([Request].[StatusID])=250 Or ([Request].[Status"
                                        "ID])=260 Or ([Request].[StatusID])=270 Or ([Request].[StatusID])=280 Or ([Reques"
                                        "t].[StatusID])=290 Or ([Request].[StatusID])=295 Or ([Request].[StatusID])=300))"
                                End
                                    Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                        "nterfaceMacro For=\"Option2089\" Event=\"OnMouseDown\" xmlns=\"http://schemas.mi"
                                        "crosoft.com/office/accessservices/2009/11/application\" xmlns:a=\"http://schemas"
                                        ".microsoft.com/office/accessserv"
                                End
                                    Comment ="_AXL:ices/2009/11/forms\"><Statements><Action Name=\"ApplyFilter\"><Argument Nam"
                                        "e=\"WhereCondition\">((([Request].[StatusID])=240 Or ([Request].[StatusID])=250 "
                                        "Or ([Request].[StatusID])=260 Or ([Request].[StatusID])=270 Or ([Request].[Statu"
                                        "sID])=280 Or ([Req"
                                End
                                    Comment ="_AXL:uest].[StatusID])=290 Or ([Request].[StatusID])=295 Or ([Request].[StatusID"
                                        "])=300))</Argument></Action></Statements></UserInterfaceMacro>"
                                End
                            End
        ...
        End
            ...
            Name ="Detail"
                    ...
                    TabIndex =5
                    ColumnInfo ="\"\";\"\";\"\";\"\";\"10\";\"100\""
                        0x0100000022010000030000000100000000000000000000003300000001000000 ,
                        0xa5a5a500edf7f9000100000000000000340000004b0000000101000000000000 ,
                        0xa7da4e0001000000000000004c0000006000000001000000a29d9600ffffff00 ,
                        0x28005b005200650061006400790046006f007200530074006100660066006900 ,
                        0x6e0067005d003d005900650073002900200041006e006400200028005b004400 ,
                        0x430050004d002000410073007300690067006e00650064005d003d0036003100 ,
                        0x32002900000000005b005200650061006400790046006f007200530074006100 ,
                        0x6600660069006e0067005d003d00590065007300000000005b00440043005000 ,
                        0x4d002000410073007300690067006e00650064005d003d003600310032000000 ,
                        0x0000
                    End
                    Name ="Status"
                    ...
                    RowSource ="SELECT RequestStatus.StatusID, RequestStatus.[DCPM Project Status] FROM RequestS"
                        "tatus ORDER BY RequestStatus.Order; "
                    ColumnWidths ="0;1440"
                    BaseInfo ="\"SELECT RequestStatus.StatusID, RequestStatus.[DCPM Project Status] FROM Reques"
                        "tStatus ORDER BY RequestStatus.Order; \";\"RequestStatus\";\"\";\"StatusID\";\"D"
                        "CPM Project Status\";\"PrimaryKey\""
                    GroupTable =9
                    GridlineColor =10921638
                    ...
                    DatasheetCaption ="Status"
                    RowStart =1
                    RowEnd =1
                    ColumnStart =5
                    ColumnEnd =5
                    LayoutGroup =1
                        0x010003000000010000000000000001000000a5a5a500edf7f900320000002800 ,
                        0x5b005200650061006400790046006f0072005300740061006600660069006e00 ,
                        0x67005d003d005900650073002900200041006e006400200028005b0044004300 ,
                        0x50004d002000410073007300690067006e00650064005d003d00360031003200 ,
                        0x2900000000000000000000000000000000000000000000010000000000000001 ,
                        0x01000000000000a7da4e00160000005b005200650061006400790046006f0072 ,
                        0x005300740061006600660069006e0067005d003d005900650073000000000000 ,
                        0x00000000000000000000000000000000010000000000000001000000a29d9600 ,
                        0xffffff00130000005b004400430050004d002000410073007300690067006e00 ,
                        0x650064005d003d00360031003200000000000000000000000000000000000000 ,
                        0x000000
                    End
                    GridlineThemeColorIndex =1
                    GridlineShade =65.0
                ...
                End
                    ...
                    GridlineColor =10921638
                        ...
                        End
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"PID\" Event=\"OnClick\" xmlns=\"http://schemas.microsoft.com"
                                "/office/accessservices/2009/11/application\" xmlns:a=\"http://schemas.microsoft."
                                "com/office/accessservices/2009/1"
                        End
                            Comment ="_AXL:1/forms\"><Statements><Action Name=\"OnError\"><Argument Name=\"Goto\">Macr"
                                "o Name</Argument><Argument Name=\"MacroName\">ErrorHandler</Argument></Action><C"
                                "onditionalBlock><If><Condition>[Form].[Dirty]</Condition><Statements><Action Nam"
                                "e=\"SaveRecord\"/></St"
                        End
                            Comment ="_AXL:atements></If></ConditionalBlock><ConditionalBlock><If><Condition>IsNull([R"
                                "equestID])</Condition><Statements><Comment>Open the form to a new record doesn't"
                                " have a RequestID/ is Null</Comment><Action Name=\"OpenForm\"><Argument Name=\"F"
                                "ormName\">Project"
                        End
                            Comment ="_AXL:Details</Argument><Argument Name=\"DataMode\">Add</Argument><Argument Name="
                                "\"WindowMode\">Dialog</Argument></Action></Statements></If><Else><Statements><Co"
                                "mment>Use a TempVar to pass a filte rto teh OpenForm Action</Comment><Action Nam"
                                "e=\"SetTempVar\"><A"
                        End
                            Comment ="_AXL:rgument Name=\"Name\">ProjectDetails_ID</Argument><Argument Name=\"Expressi"
                                "on\">[ID]</Argument></Action><Action Name=\"OpenForm\"><Argument Name=\"FormName"
                                "\">ProjectDetails</Argument><Argument Name=\"WhereCondition\">[RequestID]=[TempV"
                                "ars]![ProjectDetails_ID"
                        End
                            Comment ="_AXL:]</Argument><Argument Name=\"DataMode\">Edit</Argument><Argument Name=\"Win"
                                "dowMode\">Dialog</Argument></Action><Action Name=\"RemoveTempVar\"><Argument Nam"
                                "e=\"Name\">ProjectDetails_ID</Argument></Action><Action Name=\"RefreshRecord\"/>"
                                "</Statements></Else></C"
                        End
                            Comment ="_AXL:onditionalBlock></Statements><Sub Name=\"ErrorHandler\"><Statements><Action"
                ...
                End
                    ...
                    LayoutCachedWidth =6855
                    LayoutCachedHeight =810
                    DatasheetCaption ="Customer Name"
                    RowStart =1
                    RowEnd =1
                    ColumnStart =3
                    ColumnEnd =3
                    ...
                    GridlineColor =10921638
                        ...
                        End
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                ...
                                "office/accessservices/2009/11/application\" xmlns:a=\"http://schemas.microsoft.c"
                                "om/office/accessservices/2009/11"
                        End
                            Comment ="_AXL:/forms\"><Statements><Action Name=\"OnError\"/><ConditionalBlock><If><Condi"
                                "tion>[Form].[Dirty]</Condition><Statements><Action Name=\"SaveRecord\"/></Statem"
                                "ents></If></ConditionalBlock><ConditionalBlock><If><Condition>[MacroError].[Numb"
                                "er]&lt;&gt;0</Cond"
                        End
                            Comment ="_AXL:ition><Statements><Action Name=\"MessageBox\"><Argument Name=\"Message\">=["
                                "MacroError].[Description]</Argument></Action><Action Name=\"StopMacro\"/></State"
                                "ments></If></ConditionalBlock><Action Name=\"OnError\"><Argument Name=\"Goto\">F"
                                "ail</Argument></Action>"
                        End
                            Comment ="_AXL:<Action Name=\"OpenForm\"><Argument Name=\"FormName\">ProjectDetails</Argum"
                                "ent><Argument Name=\"WhereCondition\">=\"[ID]=\" &amp; Nz([ID],0)</Argument><Arg"
                                "ument Name=\"WindowMode\">Dialog</Argument></Action><ConditionalBlock><If><Condi"
                                "tion>Not IsNull([ID])</"
                        End
                            Comment ="_AXL:Condition><Statements><Action Name=\"SetTempVar\"><Argument Name=\"Name\">C"
                                "urrentID</Argument><Argument Name=\"Expression\">[ID]</Argument></Action></State"
                                "ments></If></ConditionalBlock><ConditionalBlock><If><Condition>IsNull([ID])</Con"
                                "dition><Statements>"
                        End
                            Comment ="_AXL:<Action Name=\"SetTempVar\"><Argument Name=\"Name\">CurrentID</Argument><Ar"
                                "gument Name=\"Expression\">Nz(DMax(\"[ID]\",[Form].[RecordSource]),0)</Argument>"
                                "</Action></Statements></If></ConditionalBlock><Action Name=\"Requery\"/><Action "
                                "Name=\"SearchForRecord\">"
                        End
                            Comment ="_AXL:<Argument Name=\"WhereCondition\">=\"[ID]=\" &amp; [TempVars]![CurrentID]</"
                                "Argument></Action><Action Name=\"RemoveTempVar\"><Argument Name=\"Name\">Current"
                                "ID</Argument></Action></Statements></UserInterfaceMacro>"
                        End
                    End
                ...
                End
                    ...
                    LayoutCachedWidth =8355
                    LayoutCachedHeight =810
                    DatasheetCaption ="Service Description"
                    RowStart =1
                    RowEnd =1
                    ColumnStart =4
                    ColumnEnd =4
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =13890
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =14205
                    RowStart =26
                    RowEnd =26
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =14880
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =15195
                    RowStart =28
                    RowEnd =28
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =15375
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =15690
                    RowStart =29
                    RowEnd =29
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =15870
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =16185
                    RowStart =30
                    RowEnd =30
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =16365
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =16680
                    RowStart =31
                    RowEnd =31
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =17355
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =17670
                    RowStart =33
                    RowEnd =33
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =18345
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =18660
                    RowStart =35
                    RowEnd =35
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =19335
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =19650
                    RowStart =37
                    RowEnd =37
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =19830
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =20145
                    RowStart =38
                    RowEnd =38
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =20325
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =20640
                    RowStart =39
                    RowEnd =39
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =20820
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =21135
                    RowStart =40
                    RowEnd =40
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =21315
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =21630
                    RowStart =41
                    RowEnd =41
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =21810
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =22125
                    RowStart =42
                    RowEnd =42
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =22305
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =22620
                    RowStart =43
                    RowEnd =43
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =23790
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =24105
                    RowStart =46
                    RowEnd =46
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =24780
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =25095
                    RowStart =48
                    RowEnd =48
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =25275
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =25590
                    RowStart =49
                    RowEnd =49
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =25770
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =26085
                    RowStart =50
                    RowEnd =50
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =26265
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =26580
                    RowStart =51
                    RowEnd =51
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =27255
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =27570
                    RowStart =53
                    RowEnd =53
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =27750
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =28065
                    RowStart =54
                    RowEnd =54
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =28245
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =28560
                    RowStart =55
                    RowEnd =55
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =29235
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =29550
                    RowStart =57
                    RowEnd =57
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =29730
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =30045
                    RowStart =58
                    RowEnd =58
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =30225
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =30540
                    RowStart =59
                    RowEnd =59
                    ColumnStart =1
                    ColumnEnd =1
                ...
                End
                    ...
                    LayoutCachedLeft =7260
                    LayoutCachedTop =31215
                    LayoutCachedWidth =8700
                    LayoutCachedHeight =31530
                    RowStart =61
                    RowEnd =61
                    ColumnStart =1
                    ColumnEnd =1
